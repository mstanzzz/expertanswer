...
style="background-image:url(asianglasses.jpg);">
-->
<div class="hero-wrap">
	<div class="home-slider owl-carousel">
		<div class="slider-item" 
		style="background-image:url(asianglass2.jpg);">
			...
			<div class="container">
				<div class="row no-gutters slider-text align-items-center justify-content-center">
					<div class="col-md-8 ">
						...
						-->
						<div class="text w-100" style="padding-top:60%;">
							<h2>Grow Your Business </h2>
							<h1 class="mb-4">Learn, Innovate and Collaborate</h1>
							<p><a href="#lgn" class="btn btn-white">
							Sign Up or Sign In
...
<section class="ftco-section ftco-no-pt ftco-faqs"  style="background-color: #FFF1E5;">
	<div class="container">
		<div class="row">
			<div class="col-lg-6">
