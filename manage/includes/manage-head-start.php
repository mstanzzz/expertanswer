...
<head>
<meta charset="UTF-8">
<title><?php echo $page_title ?> | Site Management</title>
...
<link rel="stylesheet" href="<?php echo SITEROOT; ?>/js/chosen/chosen.css" type="text/css"></link>
...
<script type="text/javascript" src="<?php echo SITEROOT; ?>/js/chosen/chosen.jquery.min.js"></script>
