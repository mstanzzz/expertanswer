...
<div class="top_nav_bar">
	<?php if($show_progress_bar){ 
		...
		$block = "<a href='".SITEROOT."/manage/setup-progress-details.php' class='progress_percentage'>";
		$block .= "Your Profile is ".$percentage."% Complete";
		$block .= "</a>";	
        $block .= "<div id='progressbar'></div>";        
		$block .= "<a href='".SITEROOT."/manage/setup-progress-details.php' class='progress_missing'>What am I missing?</a>";        
        echo $block;
