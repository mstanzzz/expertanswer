...
<body>
	<form name="add_image"  action="select-image.php?parent_cat_id=<?php echo $parent_cat_id; ?>&ret_page=<?php echo $ret_page; ?>" method="post" 
...
<a class="btn" href="<?php echo $ret_page; ?>.php?ret_page=<?php echo $ret_page; ?>'&parent_cat_id='<?php echo $parent_cat_id; ?>&banner_id=<?php echo $banner_id; ?>">
