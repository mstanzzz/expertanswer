	...
	<body style="background-color: #FFF1E5;">
		...
		<div class="container my-3 p-0">
			<div class="d-flex justify-content-end">
				<a class="btn btn-info" href="profile-skills.php"><i class="icon-arrow-left"></i> Back</a>
			</div>
		</div>
		...
		<main class="container my-3 p-0">
			<div class="card shadow-sm">
				...
				<div class="card-body">
					...
					<form name="form" action="profile-skills.php" method="post">
						<input id="id" type="hidden" name="id" value="<?php echo $id;  ?>" />
						<input type="hidden" name="update_skill" value="1" />

						<div class="form-group">
							<label for="name">Skill Name</label>
<input class="form-control" type="text" name="name" value="<?php echo $name; ?>" maxlength="250"  />
						</div>
...
<textarea class="form-control" name="description" rows="8" cols="100"><?php echo $description; ?></textarea>
						...
						<div class="d-flex justify-content-end mt-3">
							<button class="btn btn-primary" name="edit_skill" type="submit"><i class="icon-ok"></i> Save Changes</button>
						</div>
